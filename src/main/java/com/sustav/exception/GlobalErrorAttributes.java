...
public class GlobalErrorAttributes extends DefaultErrorAttributes {
  ...
  private final List<ExceptionRule> exceptionsRules = List.of(
      new ExceptionRule(ServiceException.class, HttpStatus.BAD_REQUEST),
  ...
  public Map<String, Object> getErrorAttributes(ServerRequest request,
    ...
    Optional<ExceptionRule> exceptionRuleOptional =
        exceptionsRules.stream()
                       .map(exceptionRule
                           -> exceptionRule.exceptionClass()
                                           .isInstance(error) ? exceptionRule : null)
    ...
    return exceptionRuleOptional
        ...
        .orElseGet(() -> Map.of(ErrorAttributesKey.CODE.getKey(),
  ...
  private HttpStatusCode determineHttpStatus(Throwable error) {
    return error instanceof ResponseStatusException err ? err.getStatusCode() :
        MergedAnnotations.from(error.getClass(), MergedAnnotations.SearchStrategy.TYPE_HIERARCHY)
                         ...
                         .getValue(ErrorAttributesKey.CODE.getKey(), HttpStatusCode.class)
                         .orElse(HttpStatusCode.valueOf(5));
  }
